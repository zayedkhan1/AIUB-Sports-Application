...
<div className="min-h-screen bg-gradient-to-b from-slate-50 to-blue-50 text-slate-800">
      ...
      {/* <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-2' : 'bg-transparent py-4'}`}>
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          >
            <div className="h-10 w-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center mr-3 shadow-md">
              <FaFutbol className="text-white text-xl" />
            </div>
            <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">SportConnect</h1>
          </motion.div>

          <div className="hidden md:flex space-x-8">
            <a href="#" className="font-medium hover:text-blue-500 transition-colors">Home</a>
            <a href="#" className="font-medium hover:text-blue-500 transition-colors">Find Teams</a>
            <a href="#" className="font-medium hover:text-blue-500 transition-colors">Find Players</a>
            <a href="#" className="font-medium hover:text-blue-500 transition-colors">Tournaments</a>
            <a href="#" className="font-medium hover:text-blue-500 transition-colors">Resources</a>
          </div>

          <div className="flex items-center space-x-4">
            <button className="p-2 text-slate-600 hover:text-blue-500">
              <FaBell className="text-xl" />
            </button>
            <button className="p-2 text-slate-600 hover:text-blue-500">
              <FaSearch className="text-xl" />
            </button>
            <button className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              Sign In
            </button>
              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <span className="text-slate-400 text-sm">{position.posted}</span>
                  </div>
